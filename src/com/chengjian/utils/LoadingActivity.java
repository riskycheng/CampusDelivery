		...
		new Thread() {
			...
			public void run() {
				if (loadingType.equals("login")) {
					...
					result = String.valueOf(callWebService_Login(methodName,
							UserName, UserPassword)); // 调用webservice查询
					// result =
					// String.valueOf(callWebService_Test_HelloWorld(methodName));
					// // 调用webservice查询
				} else if (loadingType.equals("query")) {
					// 获取查询的SQL语句
